...
function createFootnoteLinks(letter, letterIndex) {
    ...
    let aLinkedFootnotesArray = Array.prototype.map.call(bracketFootnotesArray, function (item) {
        return "<a class='footnote tooltipped left-align' href='#/' data-tooltip='' data-letter-id='" + letterID + "'>" + item + "</a>";
    });
...
$(document).ready(function () {
    ...
    $(document.body).on("mouseover", ".footnote", function () {
        ...
        let footnoteText = "<div class='left-align' style='padding-left: 10px; padding-right: 10px;'>" + letters[letterID - 1].footnotes[footnoteIndex].content + "</div>";
